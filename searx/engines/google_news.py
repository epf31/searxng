...
def response(resp: "SXNG_Response") -> EngineResults:
    ...
    # Try the jslog-based structure first (current Google News layout)
    ...
    # Fallback: try the new Google News structure (2025+) with IFHyqb containers
    # This layout uses div.IFHyqb containers with a.JtKRv title links and
    # base64-encoded URLs starting with "./read/"
    if not res:
